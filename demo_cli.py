...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            in_fpath = Path('/media/oscar/Seagate/Real-Time-Voice-Cloning-spanish12/alexis.wav')
            print(in_fpath)
            ...
            print('El texto que escribiste es:\n')
            text = "Hola soy alexis y quiero saber cuando estara el proyecto de deep target"
            print(text)
